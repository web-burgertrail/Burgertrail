      ...
      <CartProvider>
        <div className="min-h-screen bg-dark-900 text-white relative overflow-x-hidden">
          ...
          <a
            ...
            className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110 animate-float"
